  ...
  return (
    <div className='w-full py-[1rem] px-4'>
      ...
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
          ...
          <div className='w-full bg-[#18181B] sm:items-center sm:content-start sm:justify-item-center stroke-3 stroke-[#272728] shadow-xl flex flex-col p-4 md:my-0 my-8 rounded-tl-[40px] rounded-br-[40px] hover:scale-105 duration-300'>
